...
The objective of this task is to clean and preprocess the Titanic dataset to make it 
suitable for further analysis and machine learning. The dataset contains passenger 
information such as age, gender, class, and survival status, but it includes missing 
values, inconsistent data types, and unnecessary columns. The goal is to prepare a clean 
